...
$$
P(Refund)=P(X\ge2)=1-P(X=0)-P(X=1)=1-\frac{10!}{0!*10!}0.01^0(1-0.01)^{10-0}-\frac{10!}{1!*9!}0.01^1(1-0.01)^{10-1}\approx0.004
$$
...
$$
P(Z>0.85)=1-P(Z<0.85)\approx1-0.8023\approx0.1977
$$
...
$$
P(0.5<Z<0.85)=P(Z<0.85)-P(Z<0.5)\approx0.8023-0.6915\approx0.1108
$$
...
$$
$$
P(X>60,000)=P(Z>2.00)=1-P(Z<2.00)\approx1-0.9772\approx0.0228
$$
...
$$
P(30,000<X<60,000)=P(X<60,000)-P(X<30,000)=P(Z<2.00)-P(Z<-1.00)\approx0.9772-0.1587\approx0.8185
$$
