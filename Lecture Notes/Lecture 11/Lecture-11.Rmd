...
$$
P(Escape=6)=\frac{11!}{6!*5!}0.005^{6}(1-0.005)^{11-6}\approx7.04*10^{-12}
$$
...
$$
P(Escape\ge1)=1-P(Escape=0)=1-\frac{11!}{0!*11!}0.005^0(1-0.005)^{11-0}\approx0.0536
$$
...
$$
$$
P(12<Escape<15)=P(Escape<15)-P(Escape<12)=P(Z<-0.25)-P(Z<-1.00)\approx0.4013-0.1587\approx0.2426
$$
...
$$
$$
SD(1's)=\sqrt{Var(1's)}=\sqrt{7*\frac{1}{6}*\frac{5}{6}}=\sqrt{\frac{35}{36}}=\frac{\sqrt{35}}{6}\approx0.9860
$$
...
$$
$$
SD(Attempts)=\sqrt{5.5-2^2}=\sqrt{5.5-4}=\sqrt{1.5}\approx1.2247
$$
